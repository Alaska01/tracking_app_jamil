...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference("Movement.count") do
      post movements_url, params: { movement: { customer_id: @movement.customer_id, detail: @movement.detail, tracking_time: @movement.tracking_time } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { customer_id: @movement.customer_id, detail: @movement.detail, tracking_time: @movement.tracking_time } }
